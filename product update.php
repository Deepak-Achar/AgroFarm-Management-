<?php
	...
	$sql = "UPDATE 'fproduct' SET 'pid'=' $pid','product'='$productName','pcat'='$productType','pinfo'='$productInfo','price'='$productPrice' WHERE $pid";
	...
	<body>
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<form method="POST" action="product update.php" enctype="multipart/form-data">
						<h2>Enter the Product Information to be updated here..!!</h2>
						<br>
				<center>
					<input type="file" name="productPic" value="$" ></input>
					<br />
				</center>
				<div class="row">
					  <div class="col-sm-6">
					  ...
					  <div class="col-sm-6">
						<input type="text" name="pname" id="pname" value="<?php echo $row['product'] ?>"  style="background-color:white;color: black;" />
					  </div>
				</div>
				<br>
				<div>
			...
			<div class="row">
				<div class="col-sm-6">
					  <input type="text" name="price" id="price" value="<?php  ?>" placeholder="Price" style="background-color:white;color: black;" />
				</div>
				<div class="col-sm-6">
